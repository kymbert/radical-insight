            ...
            <div className="landing-page">
                ...
                <div className="section" id="how">
                    <div className="landing-content">
                        ...
                        <ul id="get-involved">
                            <li>Head over to <a href="https://github.com/kymbert/radical-insight" target="_blank" rel="noopener noreferrer">GitHub</a> and join the project.</li>
                            ...
                            <li>Or <a href="https://www.paypal.com/paypalme2/kymbert/5" target="_blank" rel="noopener noreferrer">buy me a cup of coffee</a> to show your support and help me keep the servers on.</li>
                        </ul>
                    </div>
                </div>
            </div>
